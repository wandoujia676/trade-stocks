...
# 版本更新记录
VERSION_LOG = [
    ("9.0-step2", "2026-05-07", [
        "新增: 基本面维度（10%）- PE/ROE/净利润增长率/资产负债率",
        "新增: 资金面维度（8%）- 主力净流入/北向持股/融资余额",
        "新增: 催化剂维度（7%）- 业绩预告/机构调研/政策利好",
        "新增: data_fetcher 三个数据接口（Tushare→AKShare 降级）",
        "新增: screener 步骤3.5 批量预取（缓存7天/1天/3天）",
        "调整: 8维度权重重新归一化，合计100%",
    ]),
    ("9.0-step1", "2026-05-07", [
        "重大: 删除滞后指标（MACD死叉/绿柱长期/KDJ死叉）",
        "重大: 新增观察池框架，右侧确认机制（实体阳+量比>1.5，T+1~T+3窗口）",
        "新增: observation_tracker 模块 + cli observation 子命令",
        "新增: screener 左侧维度≥60分自动入观察池",
        "调整: 5维度权重归一化（动量30%→25%，趋势/量价20%→22%）",
    ]),
    ("8.1", "2026-04-24", [
